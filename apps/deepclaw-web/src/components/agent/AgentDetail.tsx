    ...
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      <div className="flex items-start gap-6">
        ...
        <div className="relative">
          <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-blue-400 to-purple-600 flex items-center justify-center text-5xl shadow-lg">
            {agent.avatar}
          </div>
          <div className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full border-3 border-white ${statusColors[agent.status]} shadow-sm`} />
        </div>
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-2xl">{moodEmojis[agent.mood]}</span>
            <span className={`px-2.5 py-1 rounded-full text-xs font-medium text-white ${statusColors[agent.status]}`}>

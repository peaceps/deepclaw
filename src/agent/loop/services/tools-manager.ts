...
export class ToolsManager {
    private static readonly concurrencySafeTools: ToolDesc<any>[] = [
        readFileTool,
        todoTool,
        loadSkillTool,
        subLoopTool,
    ...
    private static readonly concurrencyUnsafeTools: ToolDesc<any>[] = [
        shellTool,
        writeFileTool,
        editFileTool,
        compactTool
    ...
    private static readonly subLoopBuiltInTools: ToolDesc<any>[] = [
        readFileTool,
        todoTool,
        shellTool,
        loadSkillTool,

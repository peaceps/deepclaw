 ...
 */
export function storeImages(images?: ImageContent[]): ImageContent[] | undefined {
    return images?.map(image => {
        ...
        const key = ImageStore.save(Buffer.from(dataUrl.base64, 'base64'), imageKeyExtension(mediaType));

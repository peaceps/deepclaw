...
export class OpenAIChatMessagesCompactor extends AbstractMessagesCompactor<ThinkingMessage, ThinkingResponse, ChatCompletionToolMessageParam, OpenAIChatLLM> {
